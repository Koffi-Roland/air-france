...
*/
	...
	@Transactional
	@Rollback(true)
	public void integrationBatchPurgeFlyingBlue_By_CIN_With_preference_TDC() throws Exception {

		// Init data
		String cin = "002029787125";
		String line = cin +  "\n";
	...
	@Transactional
	@Rollback(true)
	public void integrationBatchPurgeFlyingBlue_By_CIN_With_preference_TCC() throws Exception {

		// Init data
		String cin = "002083513396";
		String line = cin +  "\n";
	...
	@Transactional
	@Rollback(true)
	public void integrationBatchPurgeFlyingBlue_By_CIN_With_payement_preference() throws Exception {

		// Init data
		String cin = "002079528370";
		String line = cin +  "\n";
