...
//        EasyMock.replay(prospectDS);
        ...
        LinkedHashMap<String, ChangeData> ginAssociatedToBlockDTOListHm = new LinkedHashMap<String, ChangeData>();
        ginAssociatedToBlockDTOListHm.put("990080119821", changeData);
	...
	public void runSendNotifyEventIndividualTaskWithFail() throws Exception {
        ...
        LinkedHashMap<String, ChangeData> ginAssociatedToBlockDTOListHm = new LinkedHashMap<String, ChangeData>();
        ginAssociatedToBlockDTOListHm.put("412334392542", changeData);
	...
	public void runSendNotifyEventIndividualTaskNull() throws Exception {
        ...
        LinkedHashMap<String, ChangeData> ginAssociatedToBlockDTOListHm = new LinkedHashMap<String, ChangeData>();
        ginAssociatedToBlockDTOListHm.put("900334392542", changeData);
	...
	public void runSendNotifyEventIndividualTaskProspect() throws Exception {
        ...
        LinkedHashMap<String, ChangeData> ginAssociatedToBlockDTOListHm = new LinkedHashMap<String, ChangeData>();
        ginAssociatedToBlockDTOListHm.put("412334342542", changeData);
