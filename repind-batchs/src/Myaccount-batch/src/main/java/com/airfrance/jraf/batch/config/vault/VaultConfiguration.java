...
public class VaultConfiguration extends AbstractVaultConfiguration {
    ...
    public ClientAuthentication clientAuthentication() {
        ...
        Properties vaultPropertie = readVaultConfigFile();

        AppRoleAuthenticationOptions appRoleAuthenticationOptions = AppRoleAuthenticationOptions.builder()
                .roleId(AppRoleAuthenticationOptions.RoleId.provided((String) vaultPropertie.get("role-id")))
                .secretId(AppRoleAuthenticationOptions.SecretId.provided((String) vaultPropertie.get("secret-id")))
                .path("approle")
                .build();
