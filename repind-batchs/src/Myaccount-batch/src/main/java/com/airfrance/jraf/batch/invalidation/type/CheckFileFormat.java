...
import static com.airfrance.jraf.batch.invalidation.type.ConstInvalidation.EMAIL;
import static com.airfrance.jraf.batch.invalidation.type.ConstInvalidation.PHONE;
...
public abstract class CheckFileFormat {
    ...
    public final static Log log = LogFactory.getLog(CheckFileFormat.class);
