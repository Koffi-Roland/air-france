...
import com.airfrance.jraf.batch.invalidation.type.BatchInvalidationArgs;
import com.airfrance.jraf.batch.invalidation.type.CheckFileFormatInvEmail;
import com.airfrance.jraf.batch.invalidation.type.GenerateLogInvalidationEmail;
import com.airfrance.jraf.batch.invalidation.type.InvalFileFieldIndex;
...
import static com.airfrance.jraf.batch.invalidation.type.CheckFileFormat.*;
import static com.airfrance.jraf.batch.invalidation.type.CheckFileFormatInvEmail.*;
...
// AUTO SCANNING FEATURE TO GET THE BEAN NAME
@Service("batchInvalidationEmail")
public class BatchInvalidationEmail extends BatchInvalidationArgs {
 ...
 // SEND FAILURE
    ...
    private static final String NOT_TREATED = " Not treated\n";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //((BatchInvalidationEmail) batch).initTraceLevel(log);
     ...
     * @throws IOException
     * {@link #invalidAndUnsubscribe() invalidAndUnsubscribe} for caught exception
     */
    private void displayStats() throws IOException {
        ...
        synthesis.append("Nb of invalidation done in SIC EMAILS: " + nbInvalidationIndividual+"\n");
        synthesis.append("Nb of invalidation in SIC_UTF8 PROSPECT: " + nbInvalidationProspect+"\n");
        synthesis.append("Nb of untreated invalidation in SIC/SIC_UTF8: " + this.nbInvalidationNotTreated+"\n");
        synthesis.append("Invalidation already done in SIC: " + this.nbInvalidationAlreadyTreatedForIndivdiduals+"\n");   
        synthesis.append("Invalidation already done in SIC_UTF8: " + this.nbInvalidationAlreadyTreatedForProspects+"\n");
       
        synthesis.append("----\n");
        
        synthesis.append("Global opt-out in COMMUNICATION PREFERENCES:\n");        
        synthesis.append("Nb of global opt-outs set in SIC COMMUNICATION PREFERENCES: " + this.totalUnsubscribeCommunicationPreferenceForIndividuals+"\n");
        synthesis.append("Nb of global opt-outs set in SIC_UTF8 COMMUNICATION PREFERENCES: " + this.totalUnsubscribeCommunicationPreferenceForProspects+"\n");
        synthesis.append("Nb of untreated global opt-outs in SIC/SIC_UTF8: "+ this.nbSpamNotTreated+"\n");
        synthesis.append("Global optout already set in SIC: " + this.nbSpamAlreadyTreatedForIndividuals+"\n");
        ...
        synthesis.append("Nb of specific opt-outs in SIC MARKET LANGUAGE: " + this.totalUnsubscribeMarketLanguageForIndividuals+"\n");
        synthesis.append("Nb of specific opt-outs in SIC_UTF8 MARKET LANGUAGE: " +this.totalUnsubscribeMarketLanguageForProspects+"\n");
        synthesis.append("Nb of untreated specific opt-outs in SIC/SIC_UTF8: "+ this.nbUnsubscribeNotTreated+"\n");
        synthesis.append("Specific optout already set in SIC: "+ this.nbUnsubscribeAlreadyTreatedForIndividuals+ "\n"); 
        synthesis.append("Specific optout already set in SIC_UTF8: "+ this.nbUnsubscribeAlreadyTreatedForProspects+ "\n"); 
    ...
    private void reportLog(String email, String gin, String returnCode, int currentLine) {
        ...
        reportLine.append("Treatment of line  " + currentLine + " at time : " + new Date() + "\n");
        reportLine.append("Email:  " + email + "\n");
        reportLine.append("Gin: " + gin + "\n");        
        reportLine.append("Return code:  " + returnCode + "\n");
        
        reportLine.append("INVALIDATION :\n");        
        reportLine.append((this.totalInvalidEmailsSendFailureForIndividuals + this.totalInvalidEmailsHardBounceForIndividuals) + " invalidation done for Individuals / ");       
        reportLine.append((this.totalInvalidEmailsSendFailureForProspects + this.totalInvalidEmailsHardBounceForProspects) + " invalidation done for Prospects\n");
        reportLine.append(this.nbInvalidationNotTreated + NOT_TREATED);
        reportLine.append(this.nbInvalidationAlreadyTreatedForIndivdiduals + " invalidation already done for Individuals / ");       
        reportLine.append(this.nbInvalidationAlreadyTreatedForProspects + " invalidation already done for Prospects\n");
        
        reportLine.append("COMMUNICATION PREFERENCES :\n");        
        reportLine.append((this.totalUnsubscribeCommunicationPreferenceForIndividuals + this.totalUnsubscribeCommunicationPreferenceForProspects) + " global optout set / ");
        reportLine.append(this.nbSpamNotTreated + NOT_TREATED);
        reportLine.append(this.nbSpamAlreadyTreatedForIndividuals + " global optout already set for Individuals / ");       
        reportLine.append(this.nbSpamAlreadyTreatedForProspects + " global optout already set for Prospects\n");   
        
        reportLine.append("MARKET LANGUAGE :\n");        
        reportLine.append((this.totalUnsubscribeMarketLanguageForIndividuals + this.totalUnsubscribeMarketLanguageForProspects) + " specific optout set / ");
        reportLine.append(this.nbUnsubscribeNotTreated + NOT_TREATED);
        reportLine.append(this.nbUnsubscribeAlreadyTreatedForIndividuals + " specific optout already set for Individuals / ");       
        reportLine.append(this.nbUnsubscribeAlreadyTreatedForProspects + " specific optout already set for Prospects\n");   
        reportLine.append("##################\n");
     ...
     * {@link #invalidAndUnsubscribe() invalidAndUnsubscribe} for caught exceptions
     */
