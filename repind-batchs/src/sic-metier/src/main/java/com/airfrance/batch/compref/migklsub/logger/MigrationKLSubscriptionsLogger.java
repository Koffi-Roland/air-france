package com.airfrance.batch.compref.migklsub.logger;
...
public class MigrationKLSubscriptionsLogger {
    ...
    public MigrationKLSubscriptionsLogger(String csvFileName, String iPath , String[] iTitle) {
