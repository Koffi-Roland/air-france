package com.airfrance.batch.cleanTravelDoc.service;
...
@Service
@Slf4j
public class CleanTravelDocService {

    @Autowired
    private ApplicationContext ctx;

    public void execute() {
        log.info("Service CleanTravelDocService is started...");
        try {
            JobLauncher jobLauncher = (JobLauncher) ctx.getBean("jobLauncher");
            Job batchJob = (Job) ctx.getBean("cleanTravelDocJob");
