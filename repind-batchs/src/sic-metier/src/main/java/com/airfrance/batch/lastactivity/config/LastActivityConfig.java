package com.airfrance.batch.lastactivity.config;
...
import com.airfrance.batch.lastactivity.BatchLastActivity;
import com.airfrance.batch.lastactivity.model.LastActivityModel;
import com.airfrance.batch.lastactivity.processor.LastActivityProcessor;
import com.airfrance.batch.lastactivity.writer.LastActivityWriter;
 ...
 */
@ComponentScan(basePackages = {"com.airfrance.batch.lastactivity"})
@Configuration
...
public class LastActivityConfig {
     ...
     * Max Thread number
     */
    public static final int STEP_MAX_THREAD_NUMBER = 10000;
    /**
     * The number of items  selected from database per page
     */
