...
public class NewKlComPrefProcessor implements ItemProcessor<CommunicationPreferences, CommunicationPreferences> {
    ...
    @Transactional
    CommunicationPreferences createNewKLComPref(CommunicationPreferences communicationPreferences){
    ...
    @Transactional
    Set<MarketLanguage> createNewMarketLanguage(CommunicationPreferences communicationPreferences, Integer comPrefId){
