...
@echo off
java -jar %HABIL_SIMUL_JAR_PATH% --config.simul=%HABIL_SIMUL_CONFIG_JSON% --habile.proxy.backend.endpoints=/rigui-api/api/** --resilience4j.timelimiter.configs.default.timeout-duration=10s --debug
pause >nul
