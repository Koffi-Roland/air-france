...
/**
 * <p>Title : RefPreferenceKeyType.java</p>
 * BO RefPreferenceKeyType
...
public class RefPreferenceKeyType implements Serializable {
    ...
    @SequenceGenerator(name="refid_generator", sequenceName = "SEQ_REF_PREF_KEY_TYPE", allocationSize=1)
    @Column(name="REFID", insertable = false)
     ...
     */
    public RefPreferenceKeyType(Integer pRefId, String pKey, String pType, Integer pMinLength, Integer pMaxLength, String pDataType, String pCondition) {
        this.refId = pRefId;
        this.key = pKey;
        this.type = pType;
     ...
     * @param pCondition condition
     */
    public RefPreferenceKeyType(String pKey, String pType, Integer pMinLength, Integer pMaxLength, String pDataType, String pCondition) {
        this.key = pKey;
        this.type = pType;
        this.minLength = pMinLength;
        this.maxLength = pMaxLength;
