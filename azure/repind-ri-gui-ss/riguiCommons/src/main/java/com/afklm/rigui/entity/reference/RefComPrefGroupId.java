...
public class RefComPrefGroupId implements Serializable {
	 ...
	 */
	@OneToOne()
	@JoinColumn(name="REF_COMPREF_DGT_ID", nullable=false, foreignKey = @javax.persistence.ForeignKey(name = "REF_REF_COMPREF_ID_FK"))
	 ...
	 */
	@OneToOne()
	@JoinColumn(name="REF_COMPREF_GROUP_INFO_ID", nullable=false, foreignKey = @javax.persistence.ForeignKey(name = "REF_COMPREF_GROUP_INFO_ID_FK"))
