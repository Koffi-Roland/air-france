...
public class RefProductComPrefGroupId implements Serializable {
	 ...
	 */
	@OneToOne()
	@JoinColumn(name="PRODUCT_ID", nullable=false, foreignKey = @javax.persistence.ForeignKey(name = "FK_REF_PRODUCT_ID"))
	 ...
	 */
	@OneToOne()
	@JoinColumn(name="REF_COMPREF_GROUP_INFO_ID", nullable=false, foreignKey = @javax.persistence.ForeignKey(name = "FK_REF_COMPREF_GROUP_INFO_ID"))
