...
/*PROTECTED REGION ID(_jO2FMEM8EeCk2djT-5OeOA i) ENABLED START*/
...
public class TelecomDTO  {
    ...
    /*PROTECTED REGION ID(_jO2FMEM8EeCk2djT-5OeOA u var) ENABLED START*/
    ...
    public String toString() {
        String result = null;
        /*PROTECTED REGION ID(toString_jO2FMEM8EeCk2djT-5OeOA) ENABLED START*/
        result = toStringImpl();
        /*PROTECTED REGION END*/
        return result;
    }
    ...
    /*PROTECTED REGION ID(_jO2FMEM8EeCk2djT-5OeOA u m) ENABLED START*/
