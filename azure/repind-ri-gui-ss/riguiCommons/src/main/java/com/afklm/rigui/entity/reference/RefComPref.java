...
public class RefComPref implements Serializable {
    ...
    // 1 -> 1
    @OneToOne()
    @JoinColumn(name="COM_GROUP_TYPE", nullable=false, foreignKey = @javax.persistence.ForeignKey(name = "FK_REF_COMPREF_COM_GROUPE_TYPE"))
    ...
    // 1 -> 1
    @OneToOne()
    @JoinColumn(name="COM_TYPE", nullable=false, foreignKey = @javax.persistence.ForeignKey(name = "FK_REF_COMPREF_COM_TYPE"))
    ...
    // 1 -> 1
    @OneToOne()
    @JoinColumn(name="DOMAIN", nullable=false, foreignKey = @javax.persistence.ForeignKey(name = "FK_REF_COMPREF_DOMAIN"))
    ...
    // 1 -> 1
    @OneToOne()
    @JoinColumn(name="MEDIA", nullable=true, foreignKey = @javax.persistence.ForeignKey(name = "FK_REF_COMPREF_MEDIA"))
