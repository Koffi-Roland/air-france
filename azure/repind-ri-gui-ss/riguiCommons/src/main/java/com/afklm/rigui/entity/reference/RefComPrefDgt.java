...
public class RefComPrefDgt implements Serializable {
	 ...
	 */
	@OneToOne()
	@JoinColumn(name="GROUP_TYPE", nullable=false, foreignKey = @javax.persistence.ForeignKey(name = "FK_REF_COMPREF_GROUP_TYPE"))
	 ...
	 */
	@OneToOne()
	@JoinColumn(name="TYPE", nullable=false, foreignKey = @javax.persistence.ForeignKey(name = "FK_REF_COMPREF_TYPE"))
	 ...
	 * refComPrefMls
	 */
	@OneToMany(mappedBy="refComPrefDgt", cascade=CascadeType.ALL, fetch=FetchType.LAZY, orphanRemoval=true)
