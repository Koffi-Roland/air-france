...
/*PROTECTED REGION ID(_b1qUFSMUEeCWJOBY8f-ONQ i) ENABLED START*/
...
public class RoleAdresseDTO  {
    ...
    /*PROTECTED REGION ID(_b1qUFSMUEeCWJOBY8f-ONQ u var) ENABLED START*/
    ...
    public String toString() {
        String result = null;
        /*PROTECTED REGION ID(toString_b1qUFSMUEeCWJOBY8f-ONQ) ENABLED START*/
        result = toStringImpl();
        /*PROTECTED REGION END*/
        return result;
    }
    ...
    /*PROTECTED REGION ID(_b1qUFSMUEeCWJOBY8f-ONQ u m) ENABLED START*/
