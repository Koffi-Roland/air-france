...
public class RefPermissionsId implements Serializable {
	 ...
	 */
	@OneToOne()
	@JoinColumn(name="REF_PERMISSIONS_QUESTION_ID", nullable=false, foreignKey = @javax.persistence.ForeignKey(name = "FK_REF_PERMISSIONS_QUESTION"))
	 ...
	 */
	@OneToOne()
	@JoinColumn(name="REF_COMPREF_DGT_ID", nullable=false, foreignKey = @javax.persistence.ForeignKey(name = "FK_REF_COMPREF_DGT_PERM"))
