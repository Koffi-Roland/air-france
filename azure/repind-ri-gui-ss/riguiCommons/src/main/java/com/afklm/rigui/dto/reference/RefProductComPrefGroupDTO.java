...
public class RefProductComPrefGroupDTO implements Serializable {
    ...
    /**
     * refProductComPrefGroupIdDTO
     */
    private RefProductComPrefGroupIdDTO refProductComPrefGroupId;
	...
	public RefProductComPrefGroupDTO() {
		super();
	}
	

	public RefProductComPrefGroupDTO(RefProductComPrefGroupIdDTO refProductComPrefGroupId, Date dateCreation, String siteCreation,
	...
	public RefProductComPrefGroupIdDTO getRefProductComPrefGroupId() {
		return refProductComPrefGroupId;
	}


	public void setRefProductComPrefGroupId(RefProductComPrefGroupIdDTO refProductComPrefGroupId) {
		this.refProductComPrefGroupId = refProductComPrefGroupId;
	}
	...
	public String toString() {
		return "RefComPrefGroupDTO [refProductComPrefGroupId=" + refProductComPrefGroupId + ", dateCreation=" + dateCreation
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RefProductComPrefGroupDTO other = (RefProductComPrefGroupDTO) obj;
