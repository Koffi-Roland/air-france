...
import com.afklm.rigui.dto.external.ExternalIdentifierTransform;
import com.afklm.rigui.dto.preference.PreferenceDTO;
import com.afklm.rigui.dto.preference.PreferenceTransform;
import com.afklm.rigui.dto.profil.Profil_mereTransform;
...
*/
	...
	private static void bo2DtoLink(Individu individu, IndividuDTO individuDTO, boolean isFBRecognitionActivate) throws JrafDomainException {
		...
		if(individu.getPreference() != null) {
			try {
				individuDTO.setPreferenceDTO(com.afklm.rigui.dto.preference.PreferenceTransform.bo2Dto(individu.getPreference()));
			} catch (JrafDomainException e) {
				if(LOGGER.isErrorEnabled()) {
					LOGGER.error(e);
				}
