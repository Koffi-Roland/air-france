...
public class CommunicationPreferencesRequestTransform {
	...
	public static List<com.afklm.rigui.dto.individu.CommunicationPreferencesDTO> requestToDto(List<CommunicationPreferencesRequestDTO> requestDTO) {
		if (requestDTO == null) {
			return null;
		}
		
		List<com.afklm.rigui.dto.individu.CommunicationPreferencesDTO> result = new ArrayList<com.afklm.rigui.dto.individu.CommunicationPreferencesDTO>();
		
		for (CommunicationPreferencesRequestDTO comPrefReq : requestDTO) {
			com.afklm.rigui.dto.individu.CommunicationPreferencesDTO comPrefDTO = requestToDto(comPrefReq);
	...
	private static com.afklm.rigui.dto.individu.CommunicationPreferencesDTO requestToDto(CommunicationPreferencesRequestDTO req) {
		if (req == null) {
			return null;
		}
		
		com.afklm.rigui.dto.individu.CommunicationPreferencesDTO dto = new com.afklm.rigui.dto.individu.CommunicationPreferencesDTO();
		...
		if (wsDto != null) {
			...
			if (wsDto.getMarketLanguageDTO() != null) {
				...
				Set<com.afklm.rigui.dto.individu.MarketLanguageDTO> setMl = new HashSet<com.afklm.rigui.dto.individu.MarketLanguageDTO>();
				
				for (MarketLanguageDTO mlWs : mlWsList) {
					com.afklm.rigui.dto.individu.MarketLanguageDTO mlDto = new com.afklm.rigui.dto.individu.MarketLanguageDTO();
