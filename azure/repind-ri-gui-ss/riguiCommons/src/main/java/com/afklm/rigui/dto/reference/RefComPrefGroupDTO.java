...
public class RefComPrefGroupDTO implements Serializable {
     ...
     * refComPrefGroupId
     */
    private RefComPrefGroupIdDTO refComPrefGroupId;
	...
	public RefComPrefGroupDTO() {
		super();
	}
	

	public RefComPrefGroupDTO(RefComPrefGroupIdDTO refComPrefGroupId, Date dateCreation, String siteCreation,
	...
	public RefComPrefGroupIdDTO getRefComPrefGroupId() {
		return refComPrefGroupId;
	}


	public void setRefComPrefGroupId(RefComPrefGroupIdDTO refComPrefGroupId) {
		this.refComPrefGroupId = refComPrefGroupId;
	}
	...
	public String toString() {
		return "RefComPrefGroupDTO [refComPrefGroupId=" + refComPrefGroupId + ", dateCreation=" + dateCreation
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RefComPrefGroupDTO other = (RefComPrefGroupDTO) obj;
