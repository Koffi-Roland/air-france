...
import com.afklm.rigui.dto.adresse.adh.NormalisationSoftRequestDTO;
import com.afklm.rigui.dto.adresse.adh.NormalisationSoftResponseDTO;
import com.afklm.rigui.entity.adresse.PostalAddress;
import com.afklm.rigui.entity.refTable.RefTablePAYS;
import com.afklm.rigui.entity.refTable.RefTableREF_ERREUR;
...
import com.afklm.rigui.services.internal.unitservice.adresse.DqeUS;
import com.afklm.rigui.services.internal.unitservice.adresse.PostalAddressUS;
...
//			response.setNumError(!pa.getScod_err_simple().equalsIgnoreCase("0") ? pa.getScod_err_simple() : null);
		response.setReturnCode1(pa.getScod_err_simple() == null? null: Integer.valueOf(pa.getScod_err_simple()));
