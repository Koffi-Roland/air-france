...
CREATE OR REPLACE TRIGGER SIC2.LAST_ACTIVITY_COMMUNICATION_PREFERENCES
 AFTER
	INSERT OR UPDATE 
   ON
	SIC2.COMMUNICATION_PREFERENCES
   FOR EACH ROW

DECLARE
	

	v_modification_table VARCHAR2(50 BYTE) := 'COMMUNICATION_PREFERENCES';
