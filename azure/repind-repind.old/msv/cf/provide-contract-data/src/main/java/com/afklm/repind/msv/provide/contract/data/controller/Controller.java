...
public class Controller {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 403, message = "Business errors :<br />"
    ...
    public ResponseEntity<List<Contract>> getAllContract(@PathVariable String type, @PathVariable String identifier) throws BusinessException {
