...
class SearchServiceV2Test {
    ...
    void testSearchByCin() throws BusinessException {
        ...
        List<String> result = searchServiceV2.searchBy("1234AZ", null, null, null, null, null, null);
    ...
    void testSearchByEmail() throws BusinessException {
        ...
        List<String> result = searchServiceV2.searchBy( null, "email@airfrance.fr" , null, null, null, null, null);
    ...
    void testSearchByPhone() throws BusinessException {
        ...
        List<String> result = searchServiceV2.searchBy(null, null, "+33611223344", null, null, null, null);
    ...
    void testSearchByExternalIdentifier() throws BusinessException {
        ...
        List<String> result = searchServiceV2.searchBy( null, null, null, "CF8DA6C4-AF7A-467B-8D5F-CC32141CCB09", "PNM_ID", null, null);
    ...
    void testSearchByLastnameFirstname() throws BusinessException {
        ...
        List<String> result = searchServiceV2.searchBy( null, null, null, null, null, "CAROLINE", "LE PEN");
    ...
    void testSearchByException() {
        Throwable exception = assertThrows(BusinessException.class, () -> searchServiceV2.searchBy(null, null, null, null, null, null, null));
