...
import static com.afklm.repind.msv.search.individual.constant.ApiParameter.CIN;
import static com.afklm.repind.msv.search.individual.constant.ApiParameter.EMAIL;
import static com.afklm.repind.msv.search.individual.constant.ApiParameter.EXTERNAL_IDENTIFIER_ID;
import static com.afklm.repind.msv.search.individual.constant.ApiParameter.EXTERNAL_IDENTIFIER_TYPE;
import static com.afklm.repind.msv.search.individual.constant.ApiParameter.FIRST_NAME;
import static com.afklm.repind.msv.search.individual.constant.ApiParameter.FUZZY_THRESHOLD_FIRST_NAME;
import static com.afklm.repind.msv.search.individual.constant.ApiParameter.FUZZY_THRESHOLD_LAST_NAME;
import static com.afklm.repind.msv.search.individual.constant.ApiParameter.INTERNATIONAL_PHONE_NUMBER;
import static com.afklm.repind.msv.search.individual.constant.ApiParameter.LAST_NAME;
...
public class SearchRestControllerV2 {
     ...
     * @param fuzzyThresholdLastName the fuzzy threshold on lastname
     * @param fuzzyThresholdFirstName the fuzzy threshold on firstname
    ...
    public ResponseEntity<Collection<WrapperSearchIndividualV2>> search(
            ...
            @RequestParam(value = FUZZY_THRESHOLD_LAST_NAME, required = false) String fuzzyThresholdLastName,
            @RequestParam(value = FUZZY_THRESHOLD_FIRST_NAME, required = false) String fuzzyThresholdFirstName)
            throws BusinessException {

        log.info("Search input. cin {}, email {}, internationalPhoneNumber {}, externalIdentifierId{}, externalIdentifierType{}, firstname {}, lastname {}",
                cin, email, internationalPhoneNumber, externalIdentifierId, externalIdentifierType, firstname, lastname);
        ...
        List<String> gins = searchServiceV2.searchBy(cin, email, internationalPhoneNumber, externalIdentifierId, externalIdentifierType, firstname, lastname);
