...
public class DoctorRoleServiceTest {
    ...
    @Mock
    private UpdateAttributesService updateAttributesService;
    ...
    @Before
    public void setUp() {
        doctorRoleService = new DoctorRoleService(roleRepository, retrieveRoleEncoder, createRoleEncoder, updateRoleEncoder, deleteRoleEncoder, updateAttributesService);
    }
    ...
    public void retrieveDoctorRole() throws BusinessException {
        ...
        //rule
        when(roleRepository.findById("01")).thenReturn(roleOpt);
