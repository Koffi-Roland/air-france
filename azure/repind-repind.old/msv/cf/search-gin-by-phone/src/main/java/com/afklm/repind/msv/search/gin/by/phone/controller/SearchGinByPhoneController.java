...
public class SearchGinByPhoneController {
    ...
    public ResponseEntity<WrapperSearchGinByPhoneResponse> searchGinByPhone(
            @ApiParam(required = true, name = "phone", value = "Phone") @PathVariable final String phone) throws BusinessException {
        log.info("SearchGinByPhoneService start");
        return searchGinByPhoneService.search(searchGinByPhoneChecker.checkSearchGinByPhone(phone));
    }
