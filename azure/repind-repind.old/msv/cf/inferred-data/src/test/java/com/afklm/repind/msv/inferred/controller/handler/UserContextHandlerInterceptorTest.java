...
import com.afklm.repind.msv.inferred.mashery.interceptor.UserContextHandlerInterceptor;
...
class UserContextHandlerInterceptorTest {
	...
	@InjectMocks
	private final UserContextHandlerInterceptor interceptor = new UserContextHandlerInterceptor();
