package com.afklm.repind.msv.inferred.controller.handler;

import com.afklm.repind.msv.inferred.mashery.interceptor.InvalidParameterException;
import com.afklm.repind.msv.inferred.mashery.interceptor.JsonParserUtil;
import com.afklm.repind.msv.inferred.mashery.interceptor.MasheryUserContext;
import com.afklm.repind.msv.inferred.mashery.interceptor.SecurityInterceptor;
...
class SecurityInterceptorTest {
	...
	@Test
	void testCustomerIdInvalid() throws Exception {
