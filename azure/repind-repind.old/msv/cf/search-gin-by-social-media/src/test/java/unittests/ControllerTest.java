...
public class ControllerTest {
    ...
    void searchGinByExternalIdentifierTest() throws BusinessException{
        ...
        when(searchGinByExternalIdentifierService.search(id, type))
                .thenReturn(buildMockedResponse());

        ResponseEntity<WrapperSearchGinByExternalIdentifierResponse> response =
                searchGinByExternalIdentifierController.searchGinByExternalIdentifier(externalIdentifierId,externalIdentifierType);
