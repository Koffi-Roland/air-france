...
public class Consent implements Serializable {
    ...
    @SequenceGenerator(name="ISEQ_CONSENT", sequenceName="ISEQ_CONSENT", allocationSize=1)
    ...
    @OneToMany(mappedBy="consent", cascade=CascadeType.ALL, fetch=FetchType.LAZY, orphanRemoval = true)
    private List<ConsentData> consentData;
	...
	public List<ConsentData> getConsentData() {
		return consentData;
	}

	public void setConsentData(List<ConsentData> consentData) {
