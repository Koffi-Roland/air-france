package com.afklm.repind.commonpp.config.database;

import com.afklm.repind.commonpp.service.vault.VaultPpService;
...
@ConditionalOnProperty(
        ...
        havingValue = "true",
        matchIfMissing = true)
public class JpaPpConfig {

    private final Environment environment;
    private final VaultPpService vaultService;
    ...
    public DataSource getDataSourcePp() throws URISyntaxException, MalformedURLException {
        ...
        dataSourceBuilder.url(environment.getProperty("spring.datasource.url_pp"));
        dataSourceBuilder.username(info.get("sicRepindPpUsername"));
        dataSourceBuilder.password(info.get("sicRepindPpPassword"));
