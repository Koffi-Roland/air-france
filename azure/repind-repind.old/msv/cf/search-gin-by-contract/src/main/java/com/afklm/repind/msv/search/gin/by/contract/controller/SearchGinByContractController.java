...
public class SearchGinByContractController {
    ...
    public ResponseEntity<WrapperSearchGinByContractResponse> searchGinByContract(
            @ApiParam(required = true, name = "contract", value = "Contract") @PathVariable final String num) throws BusinessException {
        return searchGinByContractService.search(num);
    }
