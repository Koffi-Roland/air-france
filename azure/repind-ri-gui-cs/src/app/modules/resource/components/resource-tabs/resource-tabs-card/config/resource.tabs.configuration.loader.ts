...
import {AccountTabsCardConfiguration} from './resources/account.tabs.card.config';
  ...
  public static loadContent(type: ResourceType, resource: any): ResourceTabsCardConfiguration {
    switch (type) {
      ...
      case ResourceType.Account:
        return this.configuration(resource, AccountTabsCardConfiguration.hc, AccountTabsCardConfiguration.cc);
        default:
