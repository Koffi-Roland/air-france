...
import {
  ResourceTypeSelectorDialogComponent
} from '../../../../shared/components/dialogs/resource-type-selector-dialog/resource-type-selector-dialog.component';
...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    // We only the card ResourceType.Account if we come from a Account search
    // The isAccountEnabled status is determined by the SearchRequestType
    if(this.individualService.isAccountEnabled) {
      this.sectionCards.push(ResourceType.Account);
    }
