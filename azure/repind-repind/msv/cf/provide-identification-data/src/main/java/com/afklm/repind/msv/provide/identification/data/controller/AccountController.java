...
public class AccountController {
    ...
    public ResponseEntity<AccountDataResponse> getAccountDataByGin(@PathVariable("gin") String gin) throws BusinessException {
        gin = ProvideHelper.ginChecker(gin);

        log.info("Searching account data for GIN : {}", gin);
