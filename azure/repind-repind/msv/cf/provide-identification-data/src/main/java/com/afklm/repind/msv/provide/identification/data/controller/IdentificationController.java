...
public class IdentificationController {
    ...
    public ResponseEntity<IdentificationDataResponse> getIdentificationDateByGin(@PathVariable("gin") String gin) throws BusinessException {
        gin = ProvideHelper.ginChecker(gin);

        log.info("Searching identification data for GIN : {}", gin);
