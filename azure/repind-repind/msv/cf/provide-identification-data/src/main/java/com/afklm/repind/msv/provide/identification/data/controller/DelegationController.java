...
public class DelegationController {
    ...
    public ResponseEntity<DelegationDataResponse> getDelegationDataByGin(@PathVariable("gin") String gin) throws BusinessException {
        gin = ProvideHelper.ginChecker(gin);

        log.info("Searching delegation data for GIN : {}", gin);
