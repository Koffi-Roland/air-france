...
public class SearchGinByLastnameAndFirstnameService {
    ...
    public ResponseEntity<WrapperSearchGinByLastnameAndFirstnameResponse> search(String nom, String prenom, boolean merge) {

        // We do not provide Merged GINS
        if(!merge){
            Collection<Individu> individus = individuRepository.findByNomAndPrenomAndStatutIndividuIn(normalize(nom), normalize(prenom),
