...
public class BusinessErorMessageList {
	...
	public static final String ERROR_MESSAGE_400_003 = "Status is mandatory";
	...
	public static final String ERROR_MESSAGE_404_001 = "Preference data for this gin not found!";
	public static final String ERROR_MESSAGE_412_002 = "Invalid value for the 'gin' parameter, length must be equal to 12";
	public static final String ERROR_MESSAGE_412_003 = "Type is not allowed";
	public static final String ERROR_MESSAGE_412_004 = "Key is not allowed for this type";
	...
	public static final String ERROR_MESSAGE_412_008 = "Invalid status";
	...
	public static final String ERROR_MESSAGE_412_011 = "This status is not allowed for the update";
	...
	public static final String ERROR_MESSAGE_412_014 = "The gin doesn't correspond to the customer of the preference data";
