...
public class LoggingFilter implements Filter {
	...
	public static String getRequestPayload(final HttpServletRequest request) throws UnsupportedEncodingException {
		String payload = null;
	...
	public static String getResponsePayload(final HttpServletResponse response) throws IOException {
		String payload = null;
	...
	public static void logHeaders(final HttpServletRequest request, final HapiLog hapiLog) throws IOException {
	...
	protected boolean isLoggable(final String contentType) {
		...
		final String[] al = new String[] { "application/hal+json", MediaType.APPLICATION_JSON_VALUE,
				MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_XHTML_XML_VALUE, MediaType.TEXT_HTML_VALUE,
				MediaType.TEXT_PLAIN_VALUE, MediaType.TEXT_XML_VALUE };

		if (StringUtils.indexOfAny(contentType, al) != -1) {
			isLoggable = true;
		} else {
			/**
			 * binary types ...
