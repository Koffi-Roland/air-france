...
class SearchRestControllerTest {
    ...
    void testSearchUrl() throws BusinessException {
        ...
        when(searchServiceV2.searchBy("123456789012", null, null,  null, null, "first", "last", true)).thenReturn(Arrays.asList("012345678999","012345678999"));
        ResponseEntity<Collection<WrapperSearchIndividualV2>> response = searchRest.search( "123456789012", null, null, null, null, "first", "last", true);
