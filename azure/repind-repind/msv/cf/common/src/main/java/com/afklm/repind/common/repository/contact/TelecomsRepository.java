...
public interface TelecomsRepository extends JpaRepository<Telecoms, String> {
    ...
    Collection<Telecoms> findByNormInterPhoneNumberAndStatutMediumInAndCodeMediumInAndIndividuIsNotNull(String iPhone , Collection<String> iStatus , Collection<String> iScodes);
}
