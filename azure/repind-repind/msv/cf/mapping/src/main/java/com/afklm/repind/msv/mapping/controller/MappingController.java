...
public class MappingController {
	...
	public ResponseEntity<MappingLanguageModel> provideMappingFromNoneISOLanguage(
			@Parameter(required = true, name = "market", description = "Code Market") @PathVariable("market") final String market,
			@Parameter(required = true, name = "noneIsoLanguage", description = "None ISO Language used by context application") @PathVariable("noneIsoLanguage") final String noneIsoLanguage,
			@Parameter(required = true, name = "context", description = "Code Context") @PathVariable("context") final String context
			) 
	...
	public ResponseEntity<MappingLanguageModel> provideMappingLanguageFromISOLanguage(
			@Parameter(required = true, name = "market", description = "Code Market") @PathVariable("market") final String market,
			@Parameter(required = true, name = "isoLanguage", description = "ISO 639-1 language code used by AF Referential") @PathVariable("isoLanguage") final String isoLanguage,
			@Parameter(required = true, name = "context", description = "Code Context") @PathVariable("context") final String context)
					throws ServiceException {
	...
	public ResponseEntity<List<WrapperMappingTableForContext>> provideMappingLanguageTable(
			@Parameter(required = true, name = "context", description = "Context to get table mapping language associated, to get data for all context use : ALLCONTEXTS") @PathVariable("context") final String context)
			throws ServiceException {
