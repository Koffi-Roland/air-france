...
public enum BusinessError implements IError {
    ...
    HISTORIZED_ADR_POST_NOT_SUPPORTED_BUSINESS_ERROR(new RestError(ErrorMessage.HISTORIZED_DATA_ERROR , HttpStatus.NOT_ACCEPTABLE)),
    ...
    JWT_BUSINESS_EXCEPTION(new RestError(ErrorMessage.JWT_BUSINESS_EXCEPTION , HttpStatus.NOT_ACCEPTABLE));
