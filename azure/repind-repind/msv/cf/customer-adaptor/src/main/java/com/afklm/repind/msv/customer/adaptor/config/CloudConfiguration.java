...
public class CloudConfiguration {
    ...
    @Value("${az-vault.secrets.jaas.file_name}")
    private String jaasFileName ;
    @Value("${az-vault.secrets.jaas.secretName}")
    ...
    public void decryptJaasConfigKeytabBase64() throws IOException{
        ...
        if(jaasConfigBase64Str != null) decryptBase64(tempFilePath, jaasFileName, jaasConfigBase64Str);
        ...
        System.setProperty("java.security.auth.login.config", tempFilePath+"/"+jaasFileName);
