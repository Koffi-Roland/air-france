...
public class CheckerUtils {
    ...
    public static AirLineCode airLineCodeChecker(String iAirLineCode) throws BusinessException {
        ...
        return AirLineCode.builder().value(iAirLineCode.toUpperCase()).build();
    }
    ...
    public static Speciality specialityChecker(String speciality) throws BusinessException {
        ...
        return Speciality.builder().value(eSpeciality.getValue()).build();
    }
}
