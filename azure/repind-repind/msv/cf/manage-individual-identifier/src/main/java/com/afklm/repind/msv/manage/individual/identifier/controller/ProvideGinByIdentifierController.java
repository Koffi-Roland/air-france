...
public class ProvideGinByIdentifierController {
    ...
    public ResponseEntity<WrapperFindGinByIdentifierResponse> getGinByEmail(
            @ApiParam(required = true, name = "email", value = "email") @PathVariable("email") final String email) throws BusinessException {
        log.info("Searching GIN for email : {}", email);
    ...
    public ResponseEntity<WrapperFindGinByIdentifierResponse> getGinByCin(
            @ApiParam(required = true, name = "cin", value = "cin") @PathVariable("cin") final String cin) throws BusinessException {
        log.info("Searching GIN for CIN : {}", cin);
