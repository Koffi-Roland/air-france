...
@RestController
@RequestMapping("/PcsNonContractScore")
@CrossOrigin
public class RefPcsNonContractScoreController {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(RefPcsNonContractScoreController.class);

    @Autowired
    private RefPcsScoreService refPcsScoreService;

    private static final String CODE_FACTOR = "NC";
     ...
     * @return RefPcsNonContractScore list matching to the parameters
     * @throws JrafDaoException
     * @throws CatiCommonsException
     */
    @GetMapping(value = "/", produces = "application/json; charset=utf-8")
    public ResponseEntity<?> refPcsNonContractScoreList(HttpServletRequest httpServletRequest) throws JrafDaoException,
        ...
        try {
            ...
            String msg = "Can't retrieve asked PCS Non Contract Score List from DB";
            LOGGER.error(msg, e);
    ...
    /**
     * @param refPcsScoreDTO RefPcsNonContractScore to add
    ...
    /**
     * Delete a specific RefPcsNonContractScore
     *
