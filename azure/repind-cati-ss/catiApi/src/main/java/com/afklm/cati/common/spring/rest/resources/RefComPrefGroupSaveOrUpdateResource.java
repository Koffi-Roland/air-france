...
public class RefComPrefGroupSaveOrUpdateResource extends CatiCommonResource implements Serializable {
    ...
    private Integer refRefComPrefGroupInfoId;
	...
	public Integer getRefRefComPrefGroupInfoId() {
		return refRefComPrefGroupInfoId;
	}

	public void setRefRefComPrefGroupInfoId(Integer refRefComPrefGroupInfoId) {
		this.refRefComPrefGroupInfoId = refRefComPrefGroupInfoId;
	}
