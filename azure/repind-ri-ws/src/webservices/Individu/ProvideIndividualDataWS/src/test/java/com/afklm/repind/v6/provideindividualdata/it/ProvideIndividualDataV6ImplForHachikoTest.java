...
public class ProvideIndividualDataV6ImplForHachikoTest {

	private static final Log logger = LogFactory.getLog(ProvideIndividualDataV6ImplForHachikoTest.class);
