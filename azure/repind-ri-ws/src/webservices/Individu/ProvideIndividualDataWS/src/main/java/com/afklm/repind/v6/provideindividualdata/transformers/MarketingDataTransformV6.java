...
import com.afklm.soa.stubs.w000418.v6.response.MarketingDataResponse;
 ...
 * @author 3061561
 */
public class MarketingDataTransformV6 {
	...
	*/
	...
	public static MaccTravelCompanion transformToMaccTravelCompanion(TravelCompanionV2 bdm) {
		...
		sic.setPersonalInformation(MarketingDataTransformV6.transformToMaccPersonalInformation(bdm.getTCPersonalInformation()));
