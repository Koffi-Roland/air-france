...
import com.afklm.soa.stubs.w000418.v5.response.MarketingDataResponse;
 ...
 * @author 3061561
 */
public class MarketingDataTransformV5 {
	...
	*/
	...
	public static MaccTravelCompanion transformToMaccTravelCompanion(TravelCompanionV2 bdm) {
		...
		sic.setPersonalInformation(MarketingDataTransformV5.transformToMaccPersonalInformation(bdm.getTCPersonalInformation()));
