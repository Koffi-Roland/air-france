...
public class CreateOrUpdateV7AndProvideV5AnIndividualTest {

	private static final Log logger = LogFactory.getLog(CreateOrUpdateV7AndProvideV5AnIndividualTest.class);
	...
	@Transactional
	@Rollback(true)
	public void test_CreateOrUpdateV7_Traveler_And_ProvideIndividualv5_NOT_FOUND() throws BusinessErrorBlocBusinessException, com.afklm.soa.stubs.w000442.v7.BusinessErrorBlocBusinessException, SystemException {
		...
		logger.info("test_CreateOrUpdateV7_Traveler_And_ProvideIndividualv5_NOT_FOUND " + response.getGin());
...
//			Assert.assertNotNull(ex);
			...
			Assert.assertNotNull(ex.getFaultInfo().getBusinessError().getErrorLabel());
			
			Assert.assertEquals("NOT FOUND", (ex.getFaultInfo()).getBusinessError().getErrorLabel());
			logger.info("test_CreateOrUpdateV7_Traveler_And_ProvideIndividualv5_NOT_FOUND NOT FOUND");
	...
	@Transactional
	@Rollback(true)
	public void test_CreateOrUpdateV7_External_And_ProvideIndividualv5_NOT_FOUND() throws BusinessErrorBlocBusinessException, com.afklm.soa.stubs.w000442.v7.BusinessErrorBlocBusinessException, SystemException {
		...
		logger.info("test_CreateOrUpdateV7_External_And_ProvideIndividualv5_NOT_FOUND " + response.getGin());
...
//			Assert.assertNotNull(ex);
			...
			logger.info("test_CreateOrUpdateV7_External_And_ProvideIndividualv5_NOT_FOUND NOT FOUND");
		}
	...
	@Test
	@Ignore
	public void test_CreateOrUpdateV7_IndividuI_And_ProvideIndividualv5_FOUND() throws BusinessErrorBlocBusinessException, com.afklm.soa.stubs.w000442.v7.BusinessErrorBlocBusinessException {
		...
		logger.info("test_CreateOrUpdateV7_IndividuI_And_ProvideIndividualv5_FOUND " + response.getGin());
		...
		try {
			...
			Assert.fail("test_CreateOrUpdateV7_IndividuI_And_ProvideIndividualv5_FOUND " + ex.getMessage());
		}
	...
	@Test
	@Ignore
	public void test_CreateOrUpdateV7_IndividuNull_And_ProvideIndividualv5_FOUND() throws BusinessErrorBlocBusinessException, com.afklm.soa.stubs.w000442.v7.BusinessErrorBlocBusinessException {
		...
		logger.info("test_CreateOrUpdateV7_IndividuNull_And_ProvideIndividualv5_FOUND " + response.getGin());
		...
		try {
			...
			Assert.fail("test_CreateOrUpdateV7_IndividuNull_And_ProvideIndividualv5_FOUND " + ex.getMessage());
		}
	...
	@Test
	@Ignore
	public void test_CreateOrUpdateV7_IndividuWithAllBlock_And_ProvideIndividualv5_FOUND() throws BusinessErrorBlocBusinessException, com.afklm.soa.stubs.w000442.v7.BusinessErrorBlocBusinessException {
