...
import com.afklm.repind.v7.createorupdateindividualws.helpers.AlertHelper;
import com.afklm.repind.v7.createorupdateindividualws.helpers.CreateOrUpdateProspectHelper;
import com.afklm.repind.v7.createorupdateindividualws.transformers.IndividuResponseTransformV7;
...
import com.afklm.soa.stubs.w000442.v7.request.AlertRequest;
...
public class CreateOrUpdateV7ForAlertTest {

	private static final Log logger = LogFactory.getLog(CreateOrUpdateV7ForAlertTest.class);
	...
	private static final String GIN_INDIVIDUS_PROSPECT = "900025436715";
	...
	public void test_UpdateAlertForIndividual() throws JrafDomainException, BusinessErrorBlocBusinessException {
		...
		if(alertOri != null){
			...
			AlertData comPref = TransformAlertDataDTOToRequest(alertHelper.findAlertDataByKey(alertOri.getAlertDataDTO(), AlertHelper.PromoKeyComPrefId));			
	...
	public void test_UpdateAlertOptOut() throws JrafDomainException, BusinessErrorBlocBusinessException {
		...
		for (AlertDTO alertDTO : list) {
			alertRequest = new AlertRequest();
			alertDTO.setOptIn("N");
			alertRequest.getAlert().add(IndividuResponseTransformV7.transformToAlert(alertDTO));
			request.setAlertRequest(alertRequest);
			request.setProcess("A");
			createOrUpdateIndividualImplV7.createIndividual(request);
		}
	...
	public void test_CreateAlert2TimeWithDifferentType_REPIND637() throws JrafDomainException, BusinessErrorBlocBusinessException {		
		...
		try{		
			logger.info(createOrUpdateIndividualImplV7.createIndividual(request).toString());		
		}catch(Exception e){		
			//don't care		
		}
	...
	@Test		
	@Rollback(true)
	public void test_CreatePromoAlertWithBadKey() throws JrafDomainException, BusinessErrorBlocBusinessException {		
		logger.info("Test test_CreatePromoAlert start...");		
		...
		logger.info("Test test_CreatePromoAlertWithBadKey stop...");		
	}
