...
public class CreateOrUpdateAnIndividualImplV7ForExternalIdentifierTest {

	private static final Log logger = LogFactory.getLog(CreateOrUpdateAnIndividualImplV7ForExternalIdentifierTest.class);
	...
	private boolean updateAnIndividual(String numeroGin, String numeroGigya, String firstName, String lastName) throws BusinessErrorBlocBusinessException {
	...
	private boolean createOrUpdateAnIndividual(String process, String numeroGin, String numeroGigya, String numeroGigya2) throws BusinessErrorBlocBusinessException {
