...
public class CreateOrUpdateAnIndividualImplV8ForProspectTest {

	private static final Log logger = LogFactory.getLog(CreateOrUpdateAnIndividualImplV8ForProspectTest.class);
	...
	private static final String MAILUPDATEPROSPECT = "testmailupdateprospect@bidon.fr";
	private static final String MAILUPDATEPROSPECTOPTIN = "testmailupdateprospectoptin@bidon.fr";
	private static final String MAILUPDATEPROSPECTOPTOUT = "testmailupdateprospectoptout@bidon.fr";
	private static final String MAILUPDATEFBOPTIN = "testmailupdatefboptin@bidon.fr";
	private static final String MAILUPDATEFBOPTOUT = "testmailupdatefboptout@bidon.fr";
	private static final String MAILUPDATEMAOPTIN = "testmailupdatemaoptin@bidon.fr";
	private static final String MAILUPDATEMAOPTOUT = "testmailupdatemaoptout@bidon.fr";
...
//				Assert.assertEquals("WWP", prefData.getValue());
	...
	public void testCreateOrUpdateIndividual_Prospect_UpdateProspectAdresse() throws BusinessErrorBlocBusinessException, JrafDomainException {
		...
		Assert.assertEquals(NOANDSTREETAFTERUPDATE.toUpperCase(), postAddr.get(0).getSno_et_rue());
...
//		return response.getGin();
	...
	public CreateUpdateIndividualRequest buildRequestProspect(String noAndStreet, String numero, String preferredAirport, String comType, String marketLanguage, String optin, String nom, String mail) {
		...
		if(preferredAirport != null) {
			...
			PreferenceDataV2 preferenceDataPA = new PreferenceDataV2();
			preferenceDataPA.setKey(preferredAirportTitle);
			preferenceDataPA.setValue(preferredAirport);
			
			PreferenceDataV2 preferenceDataDest = new PreferenceDataV2();
			preferenceDataDest.setKey(preferredDestinationContinentTitle);
			preferenceDataDest.setValue("TEST");
			
// REPIND-768 : We do not need anymore to identify origin of the preference
//			PreferenceDataV2 preferenceDataType = new PreferenceDataV2();
//			preferenceDataType.setKey("type");
//			preferenceDataType.setValue("WWP");
			
			preferenceDatas.getPreferenceData().add(preferenceDataPA);
			preferenceDatas.getPreferenceData().add(preferenceDataDest);
//			preferenceDatas.getPreferenceData().add(preferenceDataType);
	...
	@Rollback(true)
	@Category(com.airfrance.repind.util.TestCategory.Slow.class)	// 15 secondes
	public void testCreateOrUpdateIndividual_Prospect_Update_ForFBSPUSH() throws BusinessErrorBlocBusinessException, JrafDomainException {
		...
		request.getRequestor().setContext("FBSPUSH");
