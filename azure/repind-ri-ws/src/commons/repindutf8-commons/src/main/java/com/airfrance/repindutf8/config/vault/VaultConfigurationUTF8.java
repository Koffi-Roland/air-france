package com.airfrance.repindutf8.config.vault;
...
@Slf4j
@Configuration()
public class VaultConfigurationUTF8 extends AbstractVaultConfiguration {

    @Inject
    VaultPropertiesUTF8 vaultProperties;
