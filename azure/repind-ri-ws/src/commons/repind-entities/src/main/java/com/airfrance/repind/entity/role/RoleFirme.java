...
/*PROTECTED REGION END*/
     ...
     */
    @Id
    @GenericGenerator(name="ISEQ_ROLE_FIRME", strategy = "com.airfrance.repind.util.StringSequenceGenerator",
    parameters = { 
    ...
    @JoinColumn(name="ICLE_ROLE", nullable=false)
    @ForeignKey(name = "FK_RF_BR")
