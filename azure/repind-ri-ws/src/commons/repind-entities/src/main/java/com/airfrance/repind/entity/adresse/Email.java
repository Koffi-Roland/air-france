...
/*PROTECTED REGION END*/
     ...
     */
    @Id
    @GenericGenerator(name="ISEQ_EMAILS", strategy = "com.airfrance.repind.util.StringSequenceGenerator",
    parameters = { 
    ...
    @JoinColumn(name="ICLE_FONCTION", nullable=true, foreignKey = @ForeignKey(name = "EMAILS_FONCTION_FK"))
    ...
    // * <-> 1
    @ManyToOne(fetch=FetchType.LAZY)
    @JoinColumn(name="SGIN_PM", nullable=true, foreignKey = @ForeignKey(name = "EMAIL_PM_FK"))
