...
@Table(name="REF_BDM_MEALS")
public class RefBdmMeals implements Serializable {
...
/*PROTECTED REGION END*/
     ...
     * labelFR
     */
    @Column(name="SLIBELLE", length=50)
     ...
     * labelEN
     */
    @Column(name="SLIBELLE_EN", length=50)
     ...
     */
    public RefBdmMeals(String pCode, String pLabelFR, String pLabelEN) {
        this.code = pCode;
