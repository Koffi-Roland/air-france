...
/*PROTECTED REGION ID(_vd2uENV0EeGWVMiDtSYzVA i) ENABLED START*/
...
/*PROTECTED REGION ID(serialUID _vd2uENV0EeGWVMiDtSYzVA) ENABLED START*/
   /**
...
/*PROTECTED REGION END*/
    ...
    /*PROTECTED REGION ID(_vd2uENV0EeGWVMiDtSYzVA u var) ENABLED START*/
     ...
     */
    public Membre(Integer pKey, Integer pVersion, String pFonction, Date pDateCreation, String pSignatureCreation, Date pDateModification, String pSignatureModification, Date pDateDebutValidite, Date pDateFinValidite, String pClient, String pContact, String pContactAf, String pEmissionHs, String pServiceAf) {
        this.key = pKey;
    ...
    public String toString() {
        String result = null;
        /*PROTECTED REGION ID(toString_vd2uENV0EeGWVMiDtSYzVA) ENABLED START*/
        result = toStringImpl();
        /*PROTECTED REGION END*/
        return result;
    }
    ...
    /*PROTECTED REGION ID(equals hash _vd2uENV0EeGWVMiDtSYzVA) ENABLED START*/
    ...
    /*PROTECTED REGION ID(_vd2uENV0EeGWVMiDtSYzVA u m) ENABLED START*/
