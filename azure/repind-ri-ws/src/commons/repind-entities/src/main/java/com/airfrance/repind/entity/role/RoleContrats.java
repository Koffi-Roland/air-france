...
/*PROTECTED REGION END*/
     ...
     */
    @Id
    @GenericGenerator(name="ISEQ_ROLE_CONTRATS", strategy = "com.airfrance.repind.util.StringSequenceGenerator",
    parameters = { 
    ...
    @JoinColumn(name="ICLE_ROLE", referencedColumnName = "ICLE_ROLE", nullable=true)
    @ForeignKey(name = "FK_ROLE_CONTRATS_ICLE_ROLE_ICLE_ROLE")
    ...
    @ForeignKey(name = "FK_ROLE_CONTRATS_SGIN_SGIN")
