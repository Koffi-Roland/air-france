package com.airfrance.repind.entity.delegation;
...
/*PROTECTED REGION END*/
     ...
     * typeGroupId
     */
    @javax.persistence.Column(name="TYPE_GROUP_ID")
    ...
    // * <-> 1
    @ManyToOne()
    @JoinColumn(name="DELEGATION_DATA_ID", nullable=false)
    @ForeignKey(name = "FK_DELEGATION_DATA_ID")
     ...
     */
    public DelegationDataInfo(Integer pDelegationDataInfoId, String pType, Integer pTypeGroupId, String pKey, String pValue, java.util.Date pDateCreation, String pSiteCreation, String pSignatureCreation, java.util.Date pDateModification, String pSiteModification, String pSignatureModification) {
