package com.airfrance.repind.entity.external;
...
public class ExternalIdentifierData implements Serializable {
	...
	// * <-> 1
	@ManyToOne()
	@JoinColumn(name = "IDENTIFIER_ID", referencedColumnName = "IDENTIFIER_ID", nullable = false)
	@ForeignKey(name = "FK_EXTERNAL_IDENTIFIER_DATA_IDENTIFIER_ID_IDENTIFIER_ID")
