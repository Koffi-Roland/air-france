...
public class PostalAddress implements Serializable, Identifiable {
	 ...
	 */
	@Id
  @GenericGenerator(name="ISEQ_ADR_POSTS", strategy = "com.airfrance.repind.util.StringSequenceGenerator",
    parameters = { 
	...
	@JoinColumn(name="ICLE_FONCTION", nullable=true)
	@org.hibernate.annotations.ForeignKey(name = "ADR_POST_FONCTION_FK")
...
//	@JoinColumn(name="SAIN_ADR", nullable=true)
	@org.hibernate.annotations.ForeignKey(name = "FK_FORMALIZED_ADR_ADR_POST")
	...
	// * <-> 1
	@ManyToOne(fetch=FetchType.LAZY)
	@JoinColumn(name="SGIN_PM", nullable=true, foreignKey = @ForeignKey(name = "ADR_PM_FK"))
	...
	@OneToMany()
	@JoinColumn(name="SAIN_ADR", nullable=true)
	@org.hibernate.annotations.ForeignKey(name = "FK_USAGE_MEDIUMS_ADR_POST")
