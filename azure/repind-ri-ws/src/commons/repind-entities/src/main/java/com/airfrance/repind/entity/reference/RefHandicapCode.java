...
@Table(name="REF_HANDICAP_CODE")
public class RefHandicapCode implements Serializable {
...
/*PROTECTED REGION END*/
     ...
     */
    public RefHandicapCode(String pCode, String pLabelFR, String pLabelEN, String pIataCode) {
        this.code = pCode;
