...
/*PROTECTED REGION END*/
    ...
    // * <-> 1
    @ManyToOne()
    @JoinColumn(name="SGIN_DELEGATE", referencedColumnName = "SGIN", nullable=false)
    @ForeignKey(name = "FK_DELEGATION_DATA_SGIN_DELEGATE_SGIN")
    ...
    // * <-> 1
    @ManyToOne()
    @JoinColumn(name="SGIN_DELEGATOR", referencedColumnName = "SGIN", nullable=false)
    @ForeignKey(name = "FK_DELEGATION_DATA_SGIN_DELEGATOR_SGIN")
