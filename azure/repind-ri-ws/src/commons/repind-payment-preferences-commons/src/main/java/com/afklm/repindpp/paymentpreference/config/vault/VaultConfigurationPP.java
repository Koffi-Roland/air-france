package com.afklm.repindpp.paymentpreference.config.vault;
...
@Slf4j
@Configuration()
public class VaultConfigurationPP extends AbstractVaultConfiguration {

    @Inject
    VaultPropertiesPP vaultProperties;
