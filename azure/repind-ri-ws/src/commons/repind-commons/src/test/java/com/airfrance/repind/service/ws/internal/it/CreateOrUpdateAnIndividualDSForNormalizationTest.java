...
public class CreateOrUpdateAnIndividualDSForNormalizationTest extends CreateOrUpdateIndividualDS{

	private static final Log logger = LogFactory.getLog(CreateOrUpdateAnIndividualDSForNormalizationTest.class);
...
//	private CreateOrUpdateIndividualImplV7 createOrUpdateIndividualImplV7;
	...
	public void testCreateOrUpdateIndividual_Create_Normalization_Force() throws JrafDomainException, JrafApplicativeException, UltimateException, UtfException, ParseException {
		...
		addRequest.setUsageAddressDTO(ua);
		...
		// Execute test
		response = createOrUpdateV8(request, response);
	...
	@Rollback(true)
	@Category(com.airfrance.repind.util.TestCategory.Slow.class)
	public void testCreateOrUpdateIndividual_Create_Normalization() throws JrafDomainException, JrafApplicativeException, UltimateException, UtfException, ParseException {
		CreateUpdateIndividualRequestDTO request = new CreateUpdateIndividualRequestDTO();
	...
	@Test
	@Ignore // versin is defined manually, test not working
	public void testCreateOrUpdateIndividual_Update_Normalization_Force() throws JrafDomainException, JrafApplicativeException, UltimateException, UtfException, ParseException {
		CreateUpdateIndividualRequestDTO request = new CreateUpdateIndividualRequestDTO();
	...
	@Test
	@Ignore // versin is defined manually, test not working
	public void testCreateOrUpdateIndividual_Update_Normalization() throws JrafDomainException, JrafApplicativeException, UltimateException, UtfException, ParseException {
		CreateUpdateIndividualRequestDTO request = new CreateUpdateIndividualRequestDTO();
	...
	@Test
	@Ignore
	public void testCreateOrUpdateIndividual_Create_Normalization_MasseRandom() {
...
//				Assert.assertNotEquals(0, response.getInformationResponse());
			...
			} catch (JrafDomainException bebe) {
				
				Assert.assertNotNull(bebe);
				logger.info("ERREUR : " + bebe.getMessage() + " pour " + adresseANormaliser);
				nbKO++;
			} catch (Exception ex) {
