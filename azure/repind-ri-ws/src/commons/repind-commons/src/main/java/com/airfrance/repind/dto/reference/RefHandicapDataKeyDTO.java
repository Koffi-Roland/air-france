 ...
 */
public class RefHandicapDataKeyDTO  implements Serializable {
     ...
     */
    public RefHandicapDataKeyDTO(String pCode, String pLabelFR, String pLabelEN, String pIataCode) {
        this.code = pCode;
