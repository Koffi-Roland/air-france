...
/*PROTECTED REGION ID(_nV_M0DRkEeCc7ZsKsK1lbQ i) ENABLED START*/
...
public class EmailDTO  implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2688059163630491603L;
    ...
    /*PROTECTED REGION ID(_nV_M0DRkEeCc7ZsKsK1lbQ u var) ENABLED START*/
    ...
    public String toString() {
        String result = null;
        /*PROTECTED REGION ID(toString_nV_M0DRkEeCc7ZsKsK1lbQ) ENABLED START*/
        result = toStringImpl();
        /*PROTECTED REGION END*/
        return result;
    }
    ...
    /*PROTECTED REGION ID(_nV_M0DRkEeCc7ZsKsK1lbQ u m) ENABLED START*/
