...
public class AdresseUS {
    ...
    /*PROTECTED REGION ID(_B9NvMHvhEeCAmbGwtfTi3Q u m) ENABLED START*/
    protected Integer getSequenceAdrPost() {
		Query qry = getEntityManager().createNativeQuery("select SIC2.ISEQ_ADR_POSTS.NEXTVAL from dual");
