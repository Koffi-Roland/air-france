...
/**
 * IdentifyCustomerCrossReferential - TelecomAgencyMemberDTO
 * @author t950700
 *
 */
public class TelecomAgencyMemberDTO {
	...
	public TelecomAgencyMemberDTO() {
		super();
	}
	
	
	public TelecomAgencyMemberDTO(String terminalType, String mediumCode,
