 ...
 */
public class RefHandicapTypeDTO  implements Serializable {
     ...
     */
    public RefHandicapTypeDTO(String pCode, String pLabelFR, String pLabelEN, String pIataCode) {
        this.code = pCode;
