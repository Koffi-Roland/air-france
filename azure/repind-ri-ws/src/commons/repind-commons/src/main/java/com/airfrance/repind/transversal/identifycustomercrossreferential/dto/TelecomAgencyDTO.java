...
/**
 * IdentifyCustomerCrossReferential - TelecomAgencyDTO
 * @author t950700
 *
 */
public class TelecomAgencyDTO {
	...
	public TelecomAgencyDTO() {
		super();
	}
	
	
	public TelecomAgencyDTO(String terminalType, String mediumCode,
