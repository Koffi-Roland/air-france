...
/**
 * IndetifyCustomerCrossReferential PostalAddressCorporateDTO
 * @author t950700
 *
 */
public class PostalAddressCorporateDTO {
	...
	public PostalAddressCorporateDTO() {
		super();
	}
	
	public PostalAddressCorporateDTO(String mediumCode, String mediumStatus,
