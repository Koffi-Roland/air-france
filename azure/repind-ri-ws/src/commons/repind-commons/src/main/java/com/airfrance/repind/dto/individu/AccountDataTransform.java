...
public final class AccountDataTransform {
    ...
    /*PROTECTED REGION ID(_couCUDLAEeCru6uc_4I2vA u var - Tr) ENABLED START*/
	private static final Log LOGGER  = LogFactory.getLog(AccountDataTransform.class);
	/*PROTECTED REGION END*/
	...
	public static List<AccountDataDTO> bo2DtoLight(List<AccountData> accountDataList) throws JrafDomainException {
		...
		for(AccountData accountData : accountDataList) {
			AccountDataDTO accountDataDTO = bo2DtoLight(accountData);
	...
	public static List<AccountDataDTO> bo2DtoLightWithIndividual(List<AccountData> accountDataList) throws JrafDomainException {
		...
		for(AccountData accountData : accountDataList) {
			AccountDataDTO accountDataDTO = bo2DtoLightIndividu(accountData);
			accountDataDTOList.add(accountDataDTO);
		}
