...
BATCH_PKG=com.afklm.batch.subscriptiondata
...
execute ${JAVA_HOME}/bin/java ${JAVA17_ARG} -Djava.security.krb5.kdc=$KDCSERVER -Djava.security.krb5.realm=$REALMENV \
                               ...
                               -cp ${CLASSPATH_RPD}:${JAVA_RPD}/subscriptiondata-0.0.1-SNAPSHOT.jar ${BATCH_PKG}.BatchCollectSharepointSubscriptionData $*
