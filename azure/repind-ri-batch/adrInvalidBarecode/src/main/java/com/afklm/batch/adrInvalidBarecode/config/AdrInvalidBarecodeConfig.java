package com.afklm.batch.adrInvalidBarecode.config;

import com.afklm.batch.adrInvalidBarecode.enums.IOFieldEnum;
import com.afklm.batch.adrInvalidBarecode.model.InputRecord;
import com.afklm.batch.adrInvalidBarecode.model.OutputRecord;
import com.afklm.batch.adrInvalidBarecode.processor.AdrInvalidBarecodeProcessor;
import com.afklm.batch.adrInvalidBarecode.service.AdrInvalidBarecodeService;
import com.afklm.batch.adrInvalidBarecode.writer.JdbcWriter;
import com.afklm.batch.adrInvalidBarecode.BatchAdrInvalidBarecode;
...
@ComponentScan(basePackages = {	"com.afklm.batch.adrInvalidBarecode"})
@Configuration
...
public class AdrInvalidBarecodeConfig {
    ...
    public FlatFileItemReader<InputRecord> csvItemReader(@Value("#{jobParameters['inputPath']}") String inputPath,
        ...
        tokenizer.setNames(IOFieldEnum.NUMERO_CONTRAT.getValue(), IOFieldEnum.SAIN.getValue(), IOFieldEnum.DATE_MODIFICATION.getValue());
    ...
    public FlatFileItemWriter<OutputRecord> csvItemWriter(@Value("#{jobParameters['outputPath']}") String outputPath,
        ...
        beanWrapperFieldExtractor.setNames(new String[] {
                IOFieldEnum.NUMERO_CONTRAT.getValue(), IOFieldEnum.SAIN.getValue(), IOFieldEnum.DATE_MODIFICATION.getValue(), IOFieldEnum.MESSAGE.getValue()
        });
