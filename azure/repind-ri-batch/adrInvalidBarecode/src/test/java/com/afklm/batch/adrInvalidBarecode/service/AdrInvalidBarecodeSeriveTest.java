...
import com.afklm.batch.adrInvalidBarecode.config.AdrInvalidBarecodeConfig;
import com.afklm.batch.adrInvalidBarecode.initData.InitDataAdrInvalidBarecode;
...
public class AdrInvalidBarecodeSeriveTest {
    ...
    public void testUpdatePoastalAddressStatusUnknownAin() throws ParseException {
    ...
    public void testUpdatePoastalAddressStatusHistory() throws ParseException {
        Objects.requireNonNull(this.outputRecord);
        assertNull(this.outputRecord.getMessage());
    ...
    public void testUpdatePoastalAddressStatusRemoved() throws ParseException {
        Objects.requireNonNull(this.outputRecord);
        assertNull(this.outputRecord.getMessage());
    ...
    public void testUpdatePoastalAddressStatusAlreadyInvalid() throws ParseException {
        Objects.requireNonNull(this.outputRecord);
        assertNull(this.outputRecord.getMessage());
    ...
    public void testUpdatePoastalAddressStatusContratNotFound() throws ParseException {
        Objects.requireNonNull(this.outputRecord);
        assertNull(this.outputRecord.getMessage());
    ...
    public void testUpdatePoastalAddressStatusAddressUpdated() throws ParseException {
        Objects.requireNonNull(this.outputRecord);
        assertNull(this.outputRecord.getMessage());
    ...
    public void testUpdatePoastalAddressStatusGinNotMatch() throws ParseException {
        Objects.requireNonNull(this.outputRecord);
        assertNull(this.outputRecord.getMessage());
