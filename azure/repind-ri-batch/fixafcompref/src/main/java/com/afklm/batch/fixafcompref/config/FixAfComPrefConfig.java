package com.afklm.batch.fixafcompref.config;

import com.afklm.batch.fixafcompref.BatchFixAfComPref;
import com.afklm.batch.fixafcompref.logger.FixAfComPrefLogger;
import com.afklm.batch.fixafcompref.mapper.FixAfComPrefLineMapper;
...
@ComponentScan(basePackages = {	"com.afklm.batch.fixafcompref" , "com.afklm.batch.fixafcompref.config"})
@Configuration
