package com.airfrance.common.batch.config;
...
@Configuration
@ComponentScan(basePackages = "com.airfrance.common.batch",
excludeFilters={@ComponentScan.Filter(type=FilterType.ASPECTJ, pattern = "com.airfrance.common.batch.config.*")})
