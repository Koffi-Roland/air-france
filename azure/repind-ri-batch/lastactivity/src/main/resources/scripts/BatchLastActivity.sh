...
BATCH_PKG=com.afklm.batch.lastactivity
...
# Lancer / relancer process
	execute ${JAVA_HOME}/bin/java  -Dbatch=BatchLastActivity -server -Xmx${memory} ${JAVA17_ARG} -cp ${CLASSPATH_RPD}:${JAVA_RPD}/lastactivity-0.0.1-SNAPSHOT.jar ${BATCH_PKG}.BatchLastActivity
