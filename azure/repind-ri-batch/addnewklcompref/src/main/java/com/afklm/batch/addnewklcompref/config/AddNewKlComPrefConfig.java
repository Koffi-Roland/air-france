package com.afklm.batch.addnewklcompref.config;



import com.afklm.batch.addnewklcompref.processor.NewKlComPrefProcessor;
import com.afklm.batch.addnewklcompref.reader.NewKlComPrefReader;
import com.afklm.batch.addnewklcompref.writer.NewKLComPrefOutputWriter;
...
@ComponentScan(basePackages = {	"com.afklm.batch.addnewklcompref"},
