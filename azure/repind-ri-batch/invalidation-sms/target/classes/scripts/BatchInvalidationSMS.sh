...
execute ${JAVA_HOME}/bin/java -Dbatch=BatchInvalidationSMS -server -Xmx${memory} ${JAVA17_ARG} -cp ${CLASSPATH_SIC}:${BASE_EXE_JAVA_DIR}/invalidation-sms-0.1.0-SNAPSHOT.jar ${BATCH_PKG}.BatchInvalidationSMS $*
