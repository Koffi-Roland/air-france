...
import com.airfrance.batch.common.config.WebConfigBatchEvent;
import com.airfrance.batch.common.enums.BatchSicUpdateNotificationArgsEnum;
...
public class BatchIndividualUpdateNotification extends BatchArgs {
    ...
    private static LinkedHashMap<String, List<BlockDTO>> ginAssociatedToBlockDTOListHm = new LinkedHashMap<>();
    ...
    static synchronized void addBlocksToSend(LinkedHashMap<String, List<BlockDTO>> ginListToBlockDTO, LinkedHashMap<String, List<Long>> ginListToTriggerChangeIdList) {
