...
BATCH_PKG=com.afklm.batch.cleanDuplicateUTFData
...
execute ${JAVA_HOME}/bin/java -Dbatch=BatchCleanDuplicateUTFData -server -Xmx${memory}  -cp ${CLASSPATH_RPD}:${JAVA_RPD}/cleanDuplicateUTFData-0.0.1-SNAPSHOT.jar ${BATCH_PKG}.BatchCleanDuplicateUTFData $*
