package com.afklm.batch.migklsub.config;


import com.afklm.batch.migklsub.BatchMigrationKLSubscriptions;
import com.afklm.batch.migklsub.enums.ModeEnum;
import com.afklm.batch.migklsub.listener.InitStepExecutionListener;
import com.afklm.batch.migklsub.logger.MigrationKLSubscriptionsLogger;
import com.afklm.batch.migklsub.mapper.MigrationKLSubLineMapper;
import com.afklm.batch.migklsub.mapper.MigrationKLSubMapper;
import com.afklm.batch.migklsub.policy.DailySkipPolicy;
import com.afklm.batch.migklsub.service.MigrationKLSubService;
...
import static com.afklm.batch.migklsub.enums.IndividuFieldEnum.*;
import static com.afklm.batch.migklsub.enums.EmailFieldEnum.EMAIL_ADDRESS;
import static com.afklm.batch.migklsub.enums.RoleContratsFieldEnum.CIN;
import static com.afklm.batch.migklsub.enums.MarketLanguageFieldEnum.*;
import static com.afklm.batch.migklsub.enums.ComPrefFieldEnum.STATUS;
import static com.afklm.batch.migklsub.enums.ComPrefFieldEnum.SUBSCRIPTION_TYPE;
import static com.afklm.batch.migklsub.enums.ComPrefFieldEnum.SIGNUP_SOURCE;

@ComponentScan(basePackages = {	"com.afklm.batch.migklsub" , "com.afklm.batch.migklsub.config"})
@Configuration
