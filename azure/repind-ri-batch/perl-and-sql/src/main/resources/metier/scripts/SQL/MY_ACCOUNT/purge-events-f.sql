...
DEFINE TABLE_TO_PURGE = "TRIGGER_CHANGE"
DEFINE TMP_TABLE = "TMP_TRIGGER_CHANGE"
DEFINE TMP_INSERT_TABLE = "TMP_TRIGGER_CHANGE_INSERT"

SPOOL &1/purge-table-TRIGGER_CHANGE.out
...
/*============================================================*/
/*============================================================*/
/* Suppression des enregistrements traités de la table        */
...
CREATE OR REPLACE TRIGGER TRG_TRIGGER_CHANGE 
BEFORE INSERT ON &TABLE_TO_PURGE 
FOR EACH ROW 
BEGIN 
INSERT INTO &TMP_INSERT_TABLE VALUES (:NEW.ID, :NEW.SGIN, :NEW.CHANGE_TABLE, 
:NEW.CHANGE_TABLE_ID, :NEW.CHANGE_TYPE, :NEW.CHANGE_TIME, 
:NEW.CHANGE_BEFORE, :NEW.CHANGE_AFTER, :NEW.CHANGE_ERROR, 
:NEW.SSIGNATURE_MODIFICATION, :NEW.SSITE_MODIFICATION, :NEW.DDATE_CREATION, 
:NEW.CHANGE_STATUS); 
END; 
/
...
DROP TRIGGER TRG_TRIGGER_CHANGE;  
