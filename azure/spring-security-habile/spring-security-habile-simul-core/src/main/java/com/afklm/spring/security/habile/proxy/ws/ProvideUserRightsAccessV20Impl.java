...
/**
 * ProvideUserRightsAccessV20 implementation for simulation
 * 
 * @author m405991
 *
 */
@Component
@WebService(endpointInterface = "com.afklm.soa.stubs.w000479.v2.ProvideUserRightsAccessV20")
public class ProvideUserRightsAccessV20Impl implements ProvideUserRightsAccessV20 {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProvideUserRightsAccessV20Impl.class);
